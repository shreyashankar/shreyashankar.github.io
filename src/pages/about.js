  ...
  render() {
    return (
      <Layout location={this.props.location} title="Shreya Shankar">
        ...
        <p>
          Currently, I am taking a break. Previously, I was the first ML engineer at <a href="https://www.viaduct.ai/">Viaduct</a>, did research at <a href="https://ai.google/research/teams/brain">Google Brain</a>, learned about investing with <a href="https://amplifypartners.com/">Amplify Partners</a>, and software engineering at <a href="https://www.facebook.com">Facebook</a>.
        </p>
        <p>
