  ...
  render() {
    return (
      <Layout location={this.props.location} title="Shreya Shankar">
        ...
        <p>
          I'm Shreya Shankar (she/her), a computer scientist living in the Bay Area. I'm interested in building systems to operationalize machine learning  (ML) workflows. My research focus is on end-to-end observability for ML systems, particularly in the context of heterogeneous stacks of tools.
        </p>
